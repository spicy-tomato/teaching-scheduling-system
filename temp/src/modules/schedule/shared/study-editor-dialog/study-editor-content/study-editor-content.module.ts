...
import { StudyEditorContentComponent } from './study-editor-content.component';
...
@NgModule({
  ...
  exports: [StudyEditorContentComponent, StudyHistoryDialogComponent],
})
export class StudyEditorContentModule {}
